                              ...
                              <div class="row">
                                <div class="col-md-3">
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2"><b>{{$count_user}}</b> Users</a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                                ...
                                <div class="col-md-3">
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2"><b>{{$count_site}}</b> Sites</a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2"><b>{{$count_plugins}}</b> Plugins</a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2"><b>{{$count_events}}</b> Events</a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                                ...
                                <div class="col-md-3">
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2"><b>{{$count_reports}}</b> Reports</a>
                                    </div>
                                </div>
